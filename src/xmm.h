...
/* Computes A' = U S V^T - A and returns || A' ||_F in extended precision. */
extern long double xdmm
...
/* Computes A' = U S V^H - A and returns || A' ||_F in extended precision. */
extern long double xzmm
