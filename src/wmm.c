...
(const double a11, const double a21, const double a12, const double a22,
 ...
 const double s, const double s1, const double s2,
 const double v11, const double v21, const double v12, const double v22)
{
  ...
  const wide /* scale U by 2^{-s}Sigma, transpose V */
...
wide wzmm
(const double a11r, const double a11i,
 const double a21r, const double a21i,
 const double a12r, const double a12i,
 const double a22r, const double a22i,
 ...
 const double v22r, const double v22i)
{
  ...
  const wide  /* scale U by 2^{-s}Sigma, conjugate-transpose V */
